...
lanternApp.factory('loadphone', ['$q', '$http',
    function ($q, $http) {
        return function (id) {
            ...
            // Add Your Web Service URL below to get the phone number for a gas station
            $http({timeout: 15000, method: 'GET', url: 'https://YOURWEBSERVICE.COM/gasstation/phonenumber/' + id, headers: {'SessionID': localStorage.SessionID}}).success(function (data) {
...
lanternApp.factory('loadcounty', ['$q', '$rootScope', '$http',
    function ($q, $rootScope, $http) {
        return function (id) {
            ...
            // Add Your Web Service URL below to get the county for this lat / lon
            $http({timeout: 15000, method: 'GET', url: 'https://YOURWEBSERVICE.COM/api/block/2010/find?format=json&latitude=' + $rootScope.position.coords.latitude + '&longitude=' + $rootScope.position.coords.longitude + '&showall=true'}).success(function (data) {
