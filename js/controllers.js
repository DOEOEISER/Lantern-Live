...
lanternControllers.controller('AlternativeCtrl', ['$scope', '$rootScope', '$window',
    function ($scope, $rootScope, $window) {
		...
		// Add Your Web Service URL below to get information on alternative fuel stations for a given location
		$scope.src = "http://YOURWEBSERVICE.COM/afdc/locator/m/stations/r?fuel=ELEC&loc=" + encodeURIComponent($rootScope.address);
		...
		$scope.searchAgain = function() {
			// Add Your Web Service URL below to get information on alternative fuel stations for a given location
			$scope.src = "http://YOURWEBSERVICE.COM/afdc/locator/m/stations/";
		};
